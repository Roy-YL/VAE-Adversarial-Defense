...
from vae_model import patch_vae_model
...
patch_size = 32
adversarial_input_path = 'fgsm_images_'
result_file = 'fgsm_results_163264.csv'
...
for i in epses:
    ...
    nontargeted_images = next(
        load_images(adversarial_input_path + str(i), batch_shape, is_training=False))
